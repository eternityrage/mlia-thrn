...
def generate_caption():
    ...
    prompt = (
        ...
        f"for the social media page 'Malia Thornton'. "
        ...
        f"- Follow Malia Thornton for daily fitness and wellness motivation! "
        f"Include relevant hashtags in ALL LOWERCASE such as #fitness #strengthtraining #gymmotivation #nutrition #healthyliving #wellness #recovery #workoutmotivation #healthylifestyle #personaltraining #fitnessjourney #motivation #selfimprovement #maliathornton. "
...
def main():
    ...
    # YouTube Shorts
    try:
        upload_to_youtube(video_path, title, description, tags=["fitness", "strengthtraining", "gym", "workout", "nutrition", "healthyliving", "wellness", "recovery", "gymmotivation", "fitnessjourney", "healthylifestyle", "personaltraining", "motivation", "maliathornton"])
